...
def inter_so3conv_grouping_anchor(grouped_xyz, anchors,
    ...
    t_rkernels = rotated_kernels[None, :, None, :, :, None] #[1, 3, 1, 60, 15, 1]
    t_gxyz = grouped_xyz[...,None,None,:] #[1, 3, 500, 1, 1, 14]
    if interpolate == 'linear':
        #  b, p2, na, ks, nn
        dists = torch.sum((t_gxyz - t_rkernels)**2, dim=1) #[1, 500, 60, 15, 14]
